...
Lang.RegisterPreset("en", {
    ...
    ["admin.noscope_allowed_label"] = "ALLOWED (%d)",
    ["admin.noscope_allowed_empty"] = "No weapons allowed yet.",
...
Lang.RegisterPreset("pt-br", {
    ...
    ["admin.noscope_allowed_label"] = "PERMITIDAS (%d)",
    ["admin.noscope_allowed_empty"] = "Nenhuma arma permitida ainda.",
...
Lang.RegisterPreset("es", {
    ...
    ["admin.noscope_allowed_label"] = "PERMITIDAS (%d)",
    ["admin.noscope_allowed_empty"] = "Todavía no hay armas permitidas.",
