...
Lang.RegisterPreset("en", {
    ...
    ["admin.webhook_title"]            = "DISCORD WEBHOOK",
    ["admin.webhook_configured"]       = "Webhook: configured",
    ["admin.webhook_not_configured"]   = "Webhook: not configured",
    ["admin.webhook_enable_label"]     = "Send achievements to Discord channel",
    ["admin.webhook_url_hint"]         = "New webhook URL (write-only — can't be viewed back)",
    ["admin.webhook_url_placeholder"]  = "https://discord.com/api/webhooks/...",
    ["admin.webhook_save"]             = "SAVE WEBHOOK",
    ["admin.webhook_remove"]           = "REMOVE WEBHOOK",
    ["admin.webhook_remove_confirm"]   = "Remove the configured Discord webhook?",
    ...
    ["admin.webhook_save_failed"]      = "Failed to save webhook.",
...
Lang.RegisterPreset("pt-br", {
    ...
    ["admin.webhook_button"]           = "DISCORD",
    ["admin.webhook_title"]            = "WEBHOOK DO DISCORD",
    ["admin.webhook_configured"]       = "Webhook: configurado",
    ["admin.webhook_not_configured"]   = "Webhook: não configurado",
    ["admin.webhook_enable_label"]     = "Enviar conquistas para canal do Discord",
    ["admin.webhook_url_hint"]         = "Nova URL do webhook (somente escrita — não pode ser visualizada depois)",
    ["admin.webhook_url_placeholder"]  = "https://discord.com/api/webhooks/...",
    ["admin.webhook_save"]             = "SALVAR WEBHOOK",
    ["admin.webhook_remove"]           = "REMOVER WEBHOOK",
    ["admin.webhook_remove_confirm"]   = "Remover o webhook do Discord configurado?",
    ...
    ["admin.webhook_save_failed"]      = "Falha ao salvar o webhook.",
...
Lang.RegisterPreset("es", {
    ...
    ["admin.hint.hours_short"]     = "Horas",
    ["admin.webhook_button"]           = "DISCORD",
    ["admin.webhook_title"]            = "WEBHOOK DE DISCORD",
    ["admin.webhook_configured"]       = "Webhook: configurado",
    ["admin.webhook_not_configured"]   = "Webhook: no configurado",
    ["admin.webhook_enable_label"]     = "Enviar logros al canal de Discord",
    ["admin.webhook_url_hint"]         = "Nueva URL del webhook (solo escritura — no se puede ver después)",
    ["admin.webhook_url_placeholder"]  = "https://discord.com/api/webhooks/...",
    ["admin.webhook_save"]             = "GUARDAR WEBHOOK",
    ["admin.webhook_remove"]           = "QUITAR WEBHOOK",
    ["admin.webhook_remove_confirm"]   = "¿Quitar el webhook de Discord configurado?",
    ...
    ["admin.webhook_save_failed"]      = "Error al guardar el webhook.",
    ["admin.lang_button"]          = "IDIOMA",
    ["admin.lang_panel_title"]     = "IDIOMA",
