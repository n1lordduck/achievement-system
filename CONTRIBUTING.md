...
- Test it. AI-generated GLua in particular tends to hallucinate functions, hooks, or realm boundaries that don't exist. Run it in-game before opening a PR.
...
Include repro steps, what you expected, what happened instead, and relevant console output. A `duck_ach_debug 1` log is often the fastest way to narrow down where something went wrong.
